...
export default () => {
    ...
    return (
        <PageContentBlock className={'content-dashboard'} title={'Dashboard'} showFlashKey={'dashboard'}>
            <div
                css={tw`mb-4 grid items-center gap-2`}
            ...
            >
                ...
                <div css={tw`flex justify-end`}>
                    {!isShowingOtherUsersServers && (
                        <Button isSecondary onClick={() => setShowGroupSettingsModal(true)}>
                            Group Settings
                        </Button>
                    )}
                </div>
                ...
                <>
                    {isShowingOtherUsersServers ? (
                        servers.length > 0 ? (
                            ...
                            <p css={tw`text-sm text-neutral-400 px-2 py-3`}>No servers found.</p>
                        )
                    ) : (
                        <>
                                ...
                                >
                                    <div css={tw`px-3 py-2 flex items-center justify-between gap-2`}>
                                        <div css={tw`flex items-center gap-2 min-w-0`}>
                                            ...
                                            >
                                                <FontAwesomeIcon icon={collapsedGroups?.[group.id] ? faChevronRight : faChevronDown} />
                                            </button>
                                            <span
                            ...
                            >
                                {groupedSections.ungrouped.length > 0 ? (
                                    ...
                                    <p css={tw`text-sm text-neutral-400 px-2 py-3`}>No ungrouped servers.</p>
                                )}
                            </div>
                        </>
                    )}
            ...
            >
                <h2 css={tw`text-lg font-semibold mb-3`}>Group Settings</h2>
                ...
                <div css={tw`space-y-2 max-h-96 overflow-y-auto pr-1`}>
                    {groups.length > 0 ? (
                        ...
                        <p css={tw`text-sm text-neutral-400`}>No groups yet.</p>
                    )}
                </div>
            </Modal>
